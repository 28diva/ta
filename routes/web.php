...
Route::get('/index', [CustumerController::class, 'wisataIndex'])->name('spk/destinasi/home.index');
Route::get('/', [CustumerController::class, 'Tes'])->name('spk/destinasi/home.index.2');
Route::get('spk/destinasi/wisata/detail/{id}', [CustumerController::class, 'wisataShow'])->name('spk/destinasi/wisata.show');
Route::get('spk/destinasi/wisata/show/{id}', [CustumerController::class, 'wisataDetail'])->name('spk/destinasi/wisata.detail');
Route::get('spk/destinasi/rekomendasi/create-2', [CustumerController::class, 'rekomendasiCreate'])->name('spk/destinasi/rekomendasi.create');
Route::get('spk/destinasi/rekomendasi/create', [CustumerController::class, 'showSearchRekomendasi'])->name('spk/destinasi/rekomendasi.create');
